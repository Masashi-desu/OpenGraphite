...
///
/// プロパティ:
/// - `expandedPageID`: 現在展開中の HTML page ID。
struct SidebarPageExpansionState: Equatable {
    ...
    ///
    /// - Parameter expandedPageID: 初期状態で展開しておく HTML page ID。
    ...
    ///
    /// - Parameter pageID: 判定対象の HTML page ID。
    ...
    ///
    /// - Parameter pageID: 展開する HTML page ID。
    ...
    ///
    /// - Parameter pageID: 開閉を切り替える HTML page ID。
    ...
    ///
    /// - Parameters:
    ///   - selectedPageID: 現在選択中の HTML page ID。選択解除時は `nil`。
    ///   - validPageIDs: 現在のサイドバーパネルに表示されている有効な HTML page ID 一覧。
